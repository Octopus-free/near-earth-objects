...
approaches.
It provides methods to fetch an NEO by primary designation or by name,
as well as a method to query the set of close approaches that match
a collection of user-specified criteria.
...
class NEODatabase:
    ...
    def __init__(self, neos, approaches):
        ...
        # create empty dictionaries to store an information about neos in
        # key: value format
        # by designation
